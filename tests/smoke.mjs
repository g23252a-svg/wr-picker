...
assert.equal(stats.Volibear.top.win,51.32);
assert.equal(stats.Volibear.jug.win,46.48);
assert.equal(stats.Swain.mid.win,52.04);
assert.equal(stats.Swain.sup.win,46.87);
